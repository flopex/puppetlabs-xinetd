...
class xinetd::params {
  ...
  case $::osfamily {
    'Debian':  {
      ...
      $service_restart    = 'bash -c "service xinetd stop ; sleep 7 ; service xinetd start"'
      $service_start      = 'bash -c "service xinetd start"'
      $service_stop       = 'bash -c "service xinetd stop"'
